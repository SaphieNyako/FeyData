...
public class ShadowCourtHistoria extends Item {

    public ShadowCourtHistoria(Properties properties) {
        super(properties);
    }
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nullable World world, @Nonnull List<ITextComponent> tooltip, @Nonnull ITooltipFlag flag) {
        TooltipHelper.addTooltip(tooltip, new TranslationTextComponent("message.feydata.shadow_court_historia"));
